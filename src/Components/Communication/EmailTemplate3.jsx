...
class EmailTemplate3Component extends Component {
  constructor(props) {
    super(props);
    if (!props.user.auth) {
      props._push('/login');
    ...
    return (
      <div>
        <Form {...formItemLayout} onSubmit={this.handleSubmit} style={{ background: "#FFFFFF", padding: "10vh", textAlign: "center" }}>
          ...
          <Form.Item label="Image" extra="Please enter a link to an image">
            {getFieldDecorator('img', {
              rules: [
                ...
                {
                  type: "url",
                  message: 'Please enter a link to an image'
                }
              ],
            })(<Input />)}
          </Form.Item>
...
const EmailTemplate3Form = Form.create({ name: 'EmailTemplate3' })(EmailTemplate3Component);
...
export default connect(mapStoreToProps, mapDispatchToProps)(EmailTemplate3Form);
