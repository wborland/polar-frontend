...
class EventDetails extends Component {
  ...
  componentDidMount = () => {
    this.props._getEventById({ auth: this.props.user.auth, id: this.props.router.location.query.id });
  }
      ...
      <div style={{ background: "#FFFFFF", minHeight: "calc(100vh - 64px)", textAlign: "center", paddingTop: "10px" }}>
        ...
        <Row style={{ marginBottom: "2vw", textAlign: "left" }}> 
          <Col sm={24} md={12} style={{paddingLeft: "2vw", textAlign: "left"}}>
            {this.props.user.permissions.includes(3) ? <Button type="primary" style={{marginRight: "1vw"}}>Modify Event</Button> : ""}
